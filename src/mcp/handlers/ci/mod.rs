...
// Post-merge task-board fallback resolve — Release-before-merge ordering fix
// tests in a sibling file.
#[cfg(test)]
#[path = "post_merge_board_fallback_tests.rs"]
#[allow(clippy::unwrap_used, clippy::expect_used)]
mod post_merge_board_fallback_tests;
