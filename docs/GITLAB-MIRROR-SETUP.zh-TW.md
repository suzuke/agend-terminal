...
當 GitHub Actions 服務降級時，可透過 GitLab 作為備援 CI 通道使用。另請參閱 [incident runbook](RUNBOOK.zh-TW.md)。
...
4. 依 [incident runbook](RUNBOOK.zh-TW.md)把結果記為 diagnostic evidence；它不能取代 required GitHub checks
